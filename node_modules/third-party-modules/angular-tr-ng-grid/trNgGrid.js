        ...
        function () {
            ...
            return {
                ...
                template: function (templateElement, tAttrs) {
                    ...
                    return '<div class="tr-ng-grid-pager form-group tr-ng-grid-custom-pager"><div class="pager-buttons btn-group" ng-show="totalItemsCount"><button class="btn btn-default" ng-disabled="!pageCanGoBack" ng-click="navigateToPage($event, gridOptions.currentPage - 1)" title="Previous Page"><i class="fa fa-angle-left"></i></button><button class="btn btn-default" ng-disabled="!pageCanGoForward" ng-click="navigateToPage($event, gridOptions.currentPage + 1)" title="Next Page"><i class="fa fa-angle-right"></i></button></div><div class="pager-select" ng-show="totalItemsCount"><select class="form-control" ng-model="gridOptions.currentPage" ng-options="pageIndex as (pageIndex+1) for pageIndex in pageIndexes"></select></div><div class="pager-status"><p ng-show="totalItemsCount"><span class="txt-color-darken">{{startItemIndex+1}}</span>&nbsp;to&nbsp;<span class="txt-color-darken">{{endItemIndex+1}}</span>&nbsp;of&nbsp;<span class="text-grey">{{totalItemsCount}}</span>&nbsp;entries</p><p ng-hide="totalItemsCount">No items to display</p></div></div>';
                },
                replace: true,
                link: {
                    pre: function (scope, compiledInstanceElement, tAttrs, controller) {
